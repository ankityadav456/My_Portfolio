...
import { Zap, ShieldCheck, LayoutGrid, Sparkles, Terminal, Award } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
          ...
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-slate-950 dark:text-white mb-3">
            A bit about how I build software
          </h2>
          <p className="text-slate-600 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
            I focus on writing frontend code that is straightforward to read, easy to maintain, and fast for the user.
          </p>
        </div>
