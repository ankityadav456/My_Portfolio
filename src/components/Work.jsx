...
const works = [
  ...
  },
  {
    ...
    description: "Responsive personal developer portfolio built with React 18, Tailwind CSS, and GSAP micro-animations. Features dark/light theme switching, iOS-inspired glassmorphic UI, smooth Lenis scrolling, and 95+ Lighthouse performance scores.",
    category: "web",
    tags: ["React.js", "Tailwind CSS", "GSAP", "Lenis", "Vite", "Git"],
    metric: "React 18 & GSAP",
  ...
  },
  {
    ...
    description: "Full CRUD dashboard for managing employee records, departments, and roles, backed by an Express REST API and MongoDB Atlas cloud database with JWT authentication and secure form handling.",
    category: "mern",
  ...
  },
  {
    ...
    description: "Responsive React.js recreation of Spotify's web player, featuring interactive track lists, album artwork rendering, audio playback controls, and persistent bottom dock player.",
    category: "web",
    tags: ["React.js", "JavaScript (ES6+)", "CSS3", "Audio Controls", "Responsive UI"],
    metric: "Responsive Web Player",
  ...
  },
  {
    ...
    description: "Native Android mobile client for food ordering, built in Kotlin with RecyclerView product feeds, custom item detail views, category filtering, and cart state handling.",
    category: "mobile",
    tags: ["Android Studio", "Kotlin", "Mobile UX", "REST APIs"],
    metric: "Kotlin & Android Studio",
  ...
  },
  {
    id: "music",
    imgSrc: music,
    title: "Android Native Music Player",
    description: "Android audio playback application developed in Kotlin with background playback service, notification controls, playlist organization, and custom seekbar manipulation.",
    category: "mobile",
    tags: ["Android", "Kotlin", "Audio Services", "Material Design"],
    metric: "Kotlin & MediaPlayer API",
