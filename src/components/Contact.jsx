const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M19.615 7.058C19.315 5.892 18.431 5.016 17.27 4.707C15.87 4.299 12 4.299 12 4.299C12 4.299 8.13 4.299 6.73 4.707C5.569 5.016 4.685 5.892 4.385 7.058C4 8.492 4 11.5 4 11.5C4 11.5 4 14.508 4.385 15.942C4.685 17.108 5.569 17.984 6.73 18.293C8.13 18.701 12 18.701 12 18.701C12 18.701 15.87 18.701 17.27 18.293C18.431 17.984 19.315 17.108 19.615 15.942C20 14.508 20 11.5 20 11.5C20 11.5 20 8.492 19.615 7.058ZM10 14.5V8.5L15.5 11.5L10 14.5Z"
          fill="currentColor"
        />
      </svg>
    ),
